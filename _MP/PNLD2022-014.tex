...
%\newwatermark[pages=1]{\includegraphics[scale=1]{watermarks/014_1.png}}
\newwatermark[pages=2]{\includegraphics[scale=1]{watermarks/014_4.png}}
\newwatermark[pages=3]{\includegraphics[scale=1]{watermarks/014_1.png}}
\newwatermark[pages=4-5]{\includegraphics[scale=1]{watermarks/014_4.png}}
\newwatermark[pages=6]{\includegraphics[scale=1]{watermarks/014_3.png}}
\newwatermark[pages=7]{\includegraphics[scale=1]{watermarks/014_4.png}}
\newwatermark[pages=8-9]{\includegraphics[scale=1]{watermarks/014_3.png}}
\newwatermark[pages=10-11]{\includegraphics[scale=1]{watermarks/014.png}}
\newwatermark[pages=12]{\includegraphics[scale=1]{watermarks/014_3.png}}
\newwatermark[pages=13-14]{\includegraphics[scale=1]{watermarks/014_2.png}}
\newwatermark[pages=15]{\includegraphics[scale=1]{watermarks/014.png}}
\newwatermark[pages=16]{\includegraphics[scale=1]{watermarks/014_1.png}}
\newwatermark[pages=17-18]{\includegraphics[scale=1]{watermarks/014_2.png}}
\newwatermark[pages=19-20]{\includegraphics[scale=1]{watermarks/014_4.png}}
\newwatermark[pages=21-22]{\includegraphics[scale=1]{watermarks/014_3.png}}
\newwatermark[pages=23-24]{\includegraphics[scale=1]{watermarks/014.png}}
\newwatermark[pages=25-26]{\includegraphics[scale=1]{watermarks/014_2.png}}
\newwatermark[pages=27]{\includegraphics[scale=1]{watermarks/014_4.png}}
%\newwatermark[allpages]{\includegraphics[scale=1]{watermarks/014.png}}
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-014-11.jpg}}
...
que ela desenvolva em casa habilidades que serão importantes no momento 
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-014-02.png}\\
O autor e ilustrador David Shterenberg (Kalinka)}
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-014-12.jpg}}
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-014-15.jpg}}
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-014-13.jpg}}
...
capacidade de os estudantes de compreenderem o que ouvem e se expressarem 
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-014-14.jpg}}
...
do livro, apontando para elas com o dedo. Destaque os sons das 
...
\includepdf[nup=2x3, 				% grid
            ...
            delta=4mm 4mm, 			
            frame,
            pages={5-6,14,17,18,21}]{./pdfs/\jobname_MIOLO.pdf}
...
\begin{enumerate}
%700 caracteres
\item \textbf{Como começar}\quad O contato da família com a criança e o livro começa desde a primeira atividade proposta. Os pais devem ser convidados para auxiliar as crianças na escolha dos objetos que serão levados no dia da atividade. Peça que, no processo de escolha, ajudem a criança a refletir sobre os aspectos do material que serão trabalhados em sala: cor, forma, dimensões etc. Eles podem, igualmente, relacionar os objetos e suas características aos usos cotidianos, reforçando as ligações entre a obra e o dia a dia da criança.
...
do que foi falado em sala de aula, quais elementos foram destacados e enfatizados pelo educador e pelos colegas. Pode-se orientar os pais a pedir que a criança fale sobre a escultura de massinha criada em sala de aula, pois isso estimula a criatividade e a memória dos alunos. Mesmo que a memória não pareça 
...
Livro sobre crítica de literatura infantil que contém definições de livro ilustrado e livro-imagem. 
\end{itemize}
...
técnicas, explicações e materiais disponíveis nessa página podem ser utilizadas em aula, mas o site também 
...
Este guia é voltado aos pais e oferece explicações em uma linguagem bastante acessível e detalhada das práticas de Literacia Familiar, 
