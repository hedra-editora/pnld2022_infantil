...
%313 caracteres
\paragraph{Publicações} Com o livro \textit{Memórias do presidente} (1997), foi um dos vencedores do 1º Festival Literário Universitário e um dos finalistas do projeto Nascente/\textsc{usp} em 1997. O livro \textit{O sapo voador} foi um dos vencedores do \textsc{iv} Concurso Literário Prof. Nelson Abel de Almeida, na categoria literatura infantil. Escreveu diversos livros sobre religião, e recentemente publicou uma novela policial. Algumas de suas publicações foram traduzidos para outros idiomas, como italiano, inglês e espanhol.
...
É importante apenas preparar o ambiente em uma sala que tenha Tv ou projetor de vídeo. Podem-se dispor almofadas no chão para que as crianças se sentem em roda em torno do vídeo a ser apresentado. Como a atividade envolve sons corporais, é interessante apenas que as crianças estejam confortáveis e à vontade para explorar seus próprios sons corporais.
...
\begin{enumerate}
%177 caracteres
\item \textbf{Contexto}\quad O objetivo desta atividade é proporcionar a interação criativa entre o gesto corporal e o livro. Pode ser realizada em sala de aula ou espaço externo com controle de ruído. Como a atividade pensa em uma leitura dialogada que também envolve a reação mais espontânea e afetiva à leitura, os alunos podem continuar sentados em roda, pois isso facilita a expressão corporal e a circulação de impressões e comentários dos alunos durante a atividade.
...
%650 caracteres
\item \textbf{O ambiente}\quad Sala de aula ou espaço externo com controle de ruído. Se for em sala de aula, é importante afastar as cadeiras para que os alunos tenham liberdade de movimento. Se for possível, o educador pode dispor nas paredes da sala algumas ilustrações do livro e alguns de seus poemas, de modo a estimular a imaginação dos estudantes e abrir novas possibilidades de leitura e criação durante a atividade.
...
está sendo trabalhado, a história que ele conta. E também que se sinta seguro para explorar as temáticas 
...
para nós e aumentar o nosso repertório. É por meio deles que melhoramos nossa 
...
\paragraph{Atividades diversas} Muitas atividades podem ser utilizadas para contribuir com a alfabetização das crianças. Jogos, brincadeiras, 
...
Este guia é voltado aos pais, e oferece explicações em linguagem bastante acessível e detalhada sobre as práticas de Literacia Familiar: como praticar leitura dialogada, como narrar histórias, como exercitar interação oral, formas de proporcionar contatos com a escrita à criança, etc. 
