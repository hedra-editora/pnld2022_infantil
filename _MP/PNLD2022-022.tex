% \Image{Capa do livro (; )}{PNLD2022-022-01.png}
% \Image{Foto do autor e ilustrador (Arquivo pessoal; )}{PNLD2022-022-02.png}
% \Image{Ilustração do livro (; )}{PNLD2022-022-04.png}
% \Image{Ilustração do livro (; )}{PNLD2022-022-05.png}
% \Image{Ilustração do livro (; )}{PNLD2022-022-06.png}
...
\newwatermark[allpages]{\includegraphics[scale=1]{watermarks/022.png}}
...
%\newcommand{\imagemCapa}{./images/PNLD2022-022-01.png}
\newcommand{\issnppub}{978-85-7715-777-8}
...
%27 caracteres
\paragraph{O livro} 
\textit{Almanaque de bichos} é um livro composto por palavras e ilustrações. 
...
\Image{No gênero prescritivo, o principal objetivo é instruir o leitor -- assim como a orientação de um dicionário. (Piqsels; Domínio público)}{PNLD2022-022-07.png}
...
Todas estão diretamente vinculadas à promoção de possibilidades de aprendizagem. E podem se relacionar também, uma vez que a cada letra e imagem outras palavras, diferentes das mencionadas no livro, podem vir à luz, à vida na água e à vida terrestre, trazendo uma visão da fauna local e mundial que ultrapasse as referências em destaque no livro. Daí ser oportuno explorar com as crianças nomes de animais que comecem com a mesma letra, mas que não estão na obra, além de ser também uma chance de pensar com elas a importância da conservação da vida marinha e terrestre. Isso posto, primeiro há uma apresentação à necessidade de se fazer as coisas de um determinado jeito. É o mundo das regras e convenções sociais. Há um modo de se escrever as palavras. E a partir de letras se formam palavras, que representam coisas. Segundo há a descoberta de novos vocabulários. Mesmo que alguns dos objetos já fizessem parte do imaginário de algumas crianças, agora passam a ser associados a suas representações escritas, o que leva a uma complexificação da realidade a partir deste novo universo. 
...
%275 caracteres
\paragraph{Competências} 
As crianças, quando em contato com as palavras e a imagens da ilustração, poderão ser solicitadas a trabalhar competências que as estimulem a pensar a fauna de maneira rica e produtiva, isto é, a troca de experiência entre elas, o conhecimento de cada um, pode vir à tona na conversa em sala. Desse modo, os saberes da \textit{Matriz de Saberes do Currículo da Cidade de São Paulo tais como Comunicação}, \textit{Abertura à Diversidade}, \textit{Empatia e Colaboração} e, sobretudo, \textit{Repertório Cultural} são eixos da leitura.
...
É importante que tenham cores chamativas e sejam bonitas. 

\Image{A sala pode ser decorada com as letras do alfabeto emborrachadas. (PxHere; Domínio público)}{PNLD2022-022-09.png}
...
\Image{É importante que o cantinho da leitura proporcione autonomia para as crianças. (Fotos Públicas/Marina Cajaíba; CC BY-NC 2.0)}{PNLD2022-022-08.png}
...
Você deve interajir durante toda a 
...
\includepdf[nup=2x3, 				% grid
            ...
            delta=4mm 4mm, 			
            frame,
            pages={16-17,78-79,125-126}]{./pdfs/\jobname_MIOLO.pdf}
...
\Image{Exemplo de imagem de animais para decoração da sala. (Pixabay; CC-BY-2.0)}{PNLD2022-022-10.png}
