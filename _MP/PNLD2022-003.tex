% \Image{Capa do livro (; )}{PNLD2022-003-01.png}

% \Image{Ilustração do livro (Araucária/Lalau e Laurabeatriz; Araucária Edições)}{PNLD2022-003-04.png}
% \Image{Ilustração do livro (Araucária/Lalau e Laurabeatriz; Araucária Edições)}{PNLD2022-003-05.png}
% \Image{Ilustração do livro (Araucária/Lalau e Laurabeatriz; Araucária Edições)}{PNLD2022-003-06.png}
...
\newwatermark[allpages]{\includegraphics[scale=1]{watermarks/003.png}}
...
\newcommand{\imagemCapa}{./images/PNLD2022-003-01.png}
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-003-02.png}\\
O autor Lalau (Arquivo pessoal)}

%862 caracteres
\paragraph{Aprofundamento} Este material tem a 
intenção de contribuir para que você consiga desenvolver um trabalho aprofundado 
com esta obra na sala de aula. Você encontrará informações sobre os autores, sobre 
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-003-03.png}\\
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-003-07.png}\\
...
\Image{É importante que o cantinho da leitura proporcione autonomia para as crianças. (Elza Fiúza/ Agência Brasil; CC BY-NC 2.0)}{PNLD2022-003-08.png}
...
\includepdf[nup=2x3, 				% grid
            ...
            delta=4mm 4mm, 			
            frame,
            pages={12-17}]{./pdfs/\jobname_MIOLO.pdf}
...
\Image{Os elementos dos livros podem ser relacionados com as tradições culturais de cada região brasileira. (Secretaria de Cultura e Turismo de Santo Amaro-Ba; CC BY-SA 4.0)}{PNLD2022-003-10.png}
...
\Image{O reconhecimento dos números é parte da atividade com as crianças. (Autoria desconhecida; Domínio público)}{PNLD2022-003-09.png}
