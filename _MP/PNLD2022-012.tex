% \Image{Capa do livro (; )}{PNLD2022-012-01.png}

% \Image{Ilustração do livro (Iluminuras/Fê; Iluminuras)}{PNLD2022-012-04.png}
% \Image{Ilustração do livro (Iluminuras/Fê; Iluminuras)}{PNLD2022-012-05.png}
% \Image{Ilustração do livro (Iluminuras/Fê; Iluminuras)}{PNLD2022-012-06.png}
...
\newwatermark[allpages]{\includegraphics[scale=1]{watermarks/012.png}}
...
\newcommand{\imagemCapa}{./images/PNLD2022-012-01.png}
...
Além da competência que diz respeito à capacidade narrativa, há também aquela
...
\marginnote{\includegraphics[width=\marginparwidth]{./images/PNLD2022-012-02.png}\\
O autor e ilustrador Fê (Arquivo pessoal)}
...
\Image{O gênero da narrativa proporciona ao leitor uma abertura ao mundo. (Pixabay/Tumisu; CC-BY-2.0)}{PNLD2022-012-07.png}
...
elementos verbais e visuais desta narrativa proporciona, então,
...
\Image{Exemplo de imagem de animais para decoração da sala. (Public domain pictures; Domínio público)}{PNLD2022-012-09.png}
...
\Image{Outro exemplo de imagem de animais para decoração da sala. (Pixabay; CC-BY-2.0)}{PNLD2022-012-10.png}
...
\Image{É importante que o cantinho da leitura proporcione autonomia para as crianças. (Elza Fiúza/ Agência Brasil; CC BY-NC 2.0)}{PNLD2022-012-08.png} 
...
\includepdf[nup=2x3, 				% grid
            ...
            delta=4mm 4mm, 			
            frame,
            pages={12-13,16-17,20-21}]{./pdfs/\jobname_MIOLO.pdf}
...
que contaram juntos. Trabalhar com essas 
...
\begin{itemize}
	...
	In: Site oficial da Universidade Federal do Pará, jan. 2019. Disponível \href{https://portal.ufpa.br/index.php/ultimas-noticias2/9573-pinturas-corporais-indigenas-sao-marcas-de-identidade-cultural}{neste link}. %Acesso em 27 ago. 2021.
...
% \includepdf[nup=2x2, 					% grid
            ...
            % delta=4mm 4mm, 			
            % frame,
            % pages={1-4}]{pdfs/PNLD2022-012_MIOLO.pdf}
